...
btwn_central.o: btwn_central.cxx btwn_central.h  generator/libgraph_generator_mpi.a  $(CTFDIR)
	$(CXX) $(CXXFLAGS) -c btwn_central.cxx $(INCLUDES)

test_btwn_central: btwn_central.o btwn_central_kernels.o test_btwn_central.cxx $(CTFDIR)
